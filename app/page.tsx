      ...
      <div className="hidden md:flex flex-col">
        ...
        <div className="flex flex-row justify-center">
          ...
          <div className="flex flex-col">
            <p className="text-4xl mt-10">오래 전부터 우리와</p>
            <p className="text-4xl ml-4 mb-6">함께 한 우리 술의 역사</p>
        ...
        <div className="flex flex-row justify-center my-36">
          <div className="flex flex-col text-end">
            <p className="text-4xl mr-12 mt-10">한국의 정서와 문화가</p>
            <p className="text-4xl mr-4 mb-6">담긴 우리 술</p>
